...
function tika_bd_divisions() {  

    $divisions = array(
        array('id' => '1', 'name' => 'Chattagram', 'url' => 'www.Chattagram.gov.bd'),
        array('id' => '2', 'name' => 'Rajshahi', 'url' => 'www.Rajshahi.gov.bd'),
        array('id' => '3', 'name' => 'Khulna', 'url' => 'www.Khulna.gov.bd'),
        array('id' => '4', 'name' => 'Barisal', 'url' => 'www.Barisal.gov.bd'),
        array('id' => '5', 'name' => 'Sylhet', 'url' => 'www.Sylhet.gov.bd'),
        array('id' => '6', 'name' => 'Dhaka', 'url' => 'www.Dhaka.gov.bd'),
        array('id' => '6', 'name' => 'Rangpur', 'url' => 'www.Rangpur.gov.bd'),
        array('id' => '6', 'name' => 'Mymensingh', 'url' => 'www.mymensingh.gov.bd')
    );

    return $divisions;
}

function tika_bd_districts() {
...
function tika_bd_categories() {

	$categories = [
		[
			'name' => 'Citizen registration - 35+ years',
			'min_age' => 35
		],
		[
			'name' => 'Govermnet officers',
			'min_age' => 18
		],
		[
			'name' => 'Defence officers',
			'min_age' => 18
		],
		[
			'name' => 'Front line media officers',
			'min_age' => 18
		],
		[
...
function tikaAgeDefference($date) {
